    ...
    <div class = "container">
    	<form name="post" method="post" action="/posts/Modifypro.do" onsubmit="return check()">
    		...
    		<table class="col-md-12 post-write">
    			 <tr>
		    		 	<th>Nickname</th>
		    		 	<td><input type="text" name="nickname" class="writer-info" value="${modify.getNickname() }" readonly="readonly"></td>
			    		<th>Password</th>
			    		<td><input type="password" name="password" class="writer-info" value="${modify.getPassword() }" readonly="readonly"></td>
			    		<th></th>
		    	 </tr>	
	    		 <tr>
	    		 	<th>Title</th>
	    		 	<td><input type="text" name="title" class="write-title" value="${modify.getTitle()}<c:if test="${modify.getSinger() }"><c:out value=" | ${modify.getSinger() }"/></c:if>"></td>
	    		 	<input type="hidden" name="singer">
	    		 </tr>
	    		 <tr>
	    		 	<th>Contents</th>
	    		 	<td><textarea name="contents" class="write-contents">${modify.getContents()}</textarea></td>
	    		 </tr>
	    		 <tr>
	    		 	<th>File</th>
