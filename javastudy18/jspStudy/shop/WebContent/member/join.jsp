					...
					<div class = "membership">
						...
						<form class="form-horizontal">
						  <div class="form-group">
						    ...
						    <div class="col-sm-10">
						      <input type="text" class="form-control" id="id" placeholder="Enter your ID" style = "width:60%; display:inline-block;">
						  ...
						  <div class="form-group">
						    <label for="password-check" class="col-sm-2 control-label">Password Check</label>
						    <div class="col-sm-10">
						      <input type="password" class="form-control" id="password-check" placeholder="Check your password">
						    </div>
						  </div>
						  <div class="form-group">
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-10">
						      <input type="text" class="form-control" id="postno" placeholder="Enter your post number" style = "width:30%; display:inline-block;">
						      <button type = "button" class = "btn btn-info">Post number</button>
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-10">
						      <input type="text" class="form-control" id="tel" placeholder="Enter your phone number">
						    </div>
						  </div>
						  <div class="form-group">
						    <label for="email" class="col-sm-2 control-label">E-mail</label>
						    <div class="col-sm-10">
						      <input type="text" class="form-control" id="email" placeholder="Enter your E-mail" style = "width:60%; display:inline-block;">
						      <button type = "button" class = "btn btn-info">Send E-mail</button>
						      <input type="text" class="form-control" id="email" placeholder="Enter the verification code" style = "width:60%; display:inline-block;">
						    </div>
						  </div>
